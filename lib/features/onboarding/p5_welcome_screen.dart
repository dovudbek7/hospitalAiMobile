// P5WelcomeScreen — F4 routing stub. The real screen lands in its build phase
...
class P5WelcomeScreen extends StatelessWidget {
    ...
    return const Scaffold(
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Center(child: ContentSlot(contentKey: 'onboarding.welcome.title', lines: 4)),
        ),
      ),
    );
  }
