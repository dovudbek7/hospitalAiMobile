// P4ConsentScreen — F4 routing stub. The real screen lands in its build phase
...
class P4ConsentScreen extends StatelessWidget {
    ...
    return const Scaffold(
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Center(child: ContentSlot(contentKey: 'onboarding.consent.title', lines: 4)),
        ),
      ),
    );
  }
