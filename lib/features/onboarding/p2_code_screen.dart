// P2CodeScreen — F4 routing stub. The real screen lands in its build phase
...
class P2CodeScreen extends StatelessWidget {
    ...
    return const Scaffold(
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Center(child: ContentSlot(contentKey: 'onboarding.code.title', lines: 4)),
        ),
      ),
    );
  }
