// P3PhoneScreen — F4 routing stub. The real screen lands in its build phase
...
class P3PhoneScreen extends StatelessWidget {
    ...
    return const Scaffold(
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Center(child: ContentSlot(contentKey: 'onboarding.phone.title', lines: 4)),
        ),
      ),
    );
  }
