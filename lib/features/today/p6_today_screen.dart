// P6TodayScreen — F4 routing stub. The real screen lands in its build phase
...
class P6TodayScreen extends StatelessWidget {
    ...
    return const Scaffold(
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Center(child: ContentSlot(contentKey: 'today.title', lines: 4)),
        ),
      ),
    );
  }
