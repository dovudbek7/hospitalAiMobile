// P12UrgentScreen — F4 routing stub. The real screen lands in its build phase
...
class P12UrgentScreen extends StatelessWidget {
    ...
    return const Scaffold(
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Center(child: ContentSlot(contentKey: 'checkin.sent.title', lines: 4)),
        ),
      ),
    );
  }
