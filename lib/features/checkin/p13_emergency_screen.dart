// P13EmergencyScreen — F4 routing stub. The real screen lands in its build phase
...
class P13EmergencyScreen extends StatelessWidget {
    ...
    return const Scaffold(
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Center(child: ContentSlot(contentKey: 'emergency.headline', lines: 4)),
        ),
      ),
    );
  }
