// P9ProgressScreen — F4 routing stub. The real screen lands in its build phase
...
class P9ProgressScreen extends StatelessWidget {
    ...
    return const Scaffold(
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Center(child: ContentSlot(contentKey: 'progress.title', lines: 4)),
        ),
      ),
    );
  }
